...
class MetricsCollector:
    ...
    def build_snapshot(self) -> dict:
        ...
        config_out = {
            "mode": self._cfg.apex_env,
            "tf_pairs": [f"{h}/{l}" for h, l in self._cfg.tf_pairs],
            "tf_entry_models": dict(self._cfg.tf_entry_models),
            "htf_lookback": self._cfg.htf_lookback,
            "htf_outputsize": self._cfg.htf_outputsize,
            ...
            "use_displacement_filter": self._cfg.use_displacement_filter,
            "displacement_atr_period": self._cfg.displacement_atr_period,
            "displacement_atr_mult": self._cfg.displacement_atr_mult,
            "tf_displacement_mult": dict(self._cfg.tf_displacement_mult),
